...
[ -f .github/actions/maestro/action.yml ] && { grep -q "default: '$MAESTRO_VERSION'" .github/actions/maestro/action.yml || { echo "::error::maestro action default != $MAESTRO_VERSION"; fail=1; }; }
