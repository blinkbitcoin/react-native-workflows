...
fail=0
grep -q "default: '$MAESTRO_VERSION'" .github/workflows/e2e.yml || { echo "::error::e2e.yml maestro-version default != $MAESTRO_VERSION"; fail=1; }
grep -q "default: $ANDROID_API_LEVEL" .github/workflows/e2e.yml || { echo "::error::e2e.yml android-api-level default != $ANDROID_API_LEVEL"; fail=1; }
