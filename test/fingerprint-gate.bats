...
@test "matching fingerprints pass the gate" {
  WORKFLOWS_FINGERPRINT_IOS=iosfp WORKFLOWS_FINGERPRINT_ANDROID=androidfp gate "$INFO"
...
@test "an iOS mismatch fails and names both hashes" {
  WORKFLOWS_FINGERPRINT_IOS=changed WORKFLOWS_FINGERPRINT_ANDROID=androidfp gate "$INFO"
...
@test "an Android mismatch fails even when iOS matches" {
  WORKFLOWS_FINGERPRINT_IOS=iosfp WORKFLOWS_FINGERPRINT_ANDROID=changed gate "$INFO"
...
@test "a missing build-info.json is fatal" {
  WORKFLOWS_FINGERPRINT_IOS=iosfp WORKFLOWS_FINGERPRINT_ANDROID=androidfp gate "$BATS_TEST_TMPDIR/nope.json"
...
@test "a build-info.json without a fingerprint block is fatal, not a pass" {
  ...
  WORKFLOWS_FINGERPRINT_IOS=iosfp WORKFLOWS_FINGERPRINT_ANDROID=androidfp gate "$BATS_TEST_TMPDIR/old.json"
